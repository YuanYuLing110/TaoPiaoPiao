...
namespace TaoPiaoPiao
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Calendar1_SelectionChanged1(object sender, EventArgs e)
        {
            ...
            //   Text += day.Date.ToShortDateString() + "<br>";

            //}
            DateTime dt = Calendar1.SelectedDate;
            List<Movie> listmovie = BLL.MovieManage.search_NewMovie_byDate(dt.ToShortTimeString());
            ...
            //ul.Controls.Add(li5);
            //hgg_div.Controls.Add(ul);

            //HtmlGenericControl h3 = new HtmlGenericControl("h3");
            //h3.Attributes.Add("class", "movie-post-mask-info");
            //h3.Attributes.Add("class", "M-post-mask-info");
            ...
            //a.Controls.Add(h3);
            //hgg_div.Controls.Add(a);
            //movie_post.Controls.Add(hgg_div);

            //time_info.InnerText = dt.ToString() + "上映" + listmovie.Count + "部";
        }

        protected void btn_chaxun_Click(object sender, EventArgs e)
        {
            //Utility.JavaScript.Alert(Calendar1.SelectedDate.ToLongDateString(), this);
            Utility.JavaScript.Alert("bbbbbbbbbbbbb", this);
        }
